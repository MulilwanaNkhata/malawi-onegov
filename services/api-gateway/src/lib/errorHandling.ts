 ...
 * rejection and (since Node 15) terminates the process by default. As the
 * single public entry point to the whole platform, this service crashing
 * would take every downstream service's citizen-facing traffic down with it.
 *
 ...
 * handling errors close to where they happen.
 */
