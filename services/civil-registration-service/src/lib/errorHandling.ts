 ...
 * practice that meant a single bad request (or a failed event-consumer
 * callback, e.g. certificate generation) could take the entire service down
 * until someone noticed and restarted the container.
 *
