 ...
 * practice that meant a single bad request (or, here, a single failed
 * notification event) could take the entire service down until someone
 * noticed and restarted the container.
 *
